...
$site_top = "https://web-tera-design.com/restaurant";

//管理者のメールアドレス（送信先） ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "toru-yamaguchi1.11@outlook.jp,smartgroup.kanri01@gmail.com";
...
$from = "toru-yamaguchi1.11@outlook.jp,smartgroup.kanri01@gmail.com";
...
$require = array('会社名（店舗名）', 'お名前', 'Email', '電話番号', 'プライバシー同意');
...
以下の内容で、お受け付けいたしました。
担当者よりご連絡いたしますので、今しばらくおまちくださいませ。
TEXT;
...
会社名：株式会社スマートグループ
住所：〒660-0868 兵庫県尼崎市西御園町119番地3第一寺町ビル7F
電話番号：06-4950-4776
公式サイト：https://www.smart-group.jp/
FOOTER;
...
<?php } else { ?>
	<div class="thank-you-message">
		<h2 class="thank-you-title">お問い合わせありがとうございました。</h2>
		<p class="thank-you-text">送信は正常に完了しました。</p>
		<p><a href="<?php echo $site_top; ?>" class="btn-return-home">トップページへ戻る&raquo;</a></p>
	</div>
	</div>
	<!-- <?php copyright(); ?> -->
